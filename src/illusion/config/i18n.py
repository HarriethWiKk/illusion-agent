...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "print_mode_pending_permission_exit": {"zh-CN": "权限请求: {tool}，请使用 illusion -c -p \"Y\" 允许一次 / \"F\" 始终允许 / \"N\" 拒绝", "en-US": "Permission request: {tool}. Use illusion -c -p \"Y\" to allow once / \"F\" to always allow / \"N\" to deny"},
