...
const ZH: Record<string, string> = {
  ...
  web_settings_title: '设置',
  web_onboarding_subtitle: '配置 API 环境以开始使用',
  web_env_add: '新增环境',
  web_env_delete: '删除',
  web_env_activate: '设为当前',
  web_env_active: '当前',
  web_env_api_format: 'API 格式',
  web_env_base_url: 'Base URL',
  web_env_api_key: 'API Key',
  web_env_model: '模型',
  web_env_add_model: '新增模型',
  web_env_remove_model: '移除模型',
  web_env_oauth_login_github: '使用 GitHub 登录',
  web_env_oauth_login_openai: '使用 OpenAI 登录',
  web_env_oauth_waiting: '请在弹出的浏览器窗口中完成授权...',
  web_env_oauth_success: 'OAuth 认证成功',
  web_env_oauth_failed: 'OAuth 认证失败',
  web_env_model_required: '请输入模型名称',
  web_env_authorized: '已授权',
  web_env_model_optional: '（可选）',
  web_env_select_to_edit: '选择环境以编辑',
  web_ui_language: '界面语言',
  web_settings_save: '保存',
  web_settings_cancel: '取消',
  web_settings_close: '关闭',
  settings_tooltip: '设置',
};
...
const EN: Record<string, string> = {
  ...
  web_onboarding_subtitle: 'Configure API environment to get started',
  web_env_add: 'Add Environment',
  web_env_delete: 'Delete',
  web_env_activate: 'Activate',
  web_env_active: 'Active',
  web_env_api_format: 'API Format',
  web_env_base_url: 'Base URL',
  web_env_api_key: 'API Key',
  web_env_model: 'Model',
  web_env_add_model: 'Add Model',
  web_env_remove_model: 'Remove Model',
  web_env_oauth_login_github: 'Login with GitHub',
  web_env_oauth_login_openai: 'Login with OpenAI',
  web_env_oauth_waiting: 'Please complete authorization in the browser window...',
  web_env_oauth_success: 'OAuth authentication successful',
  web_env_oauth_failed: 'OAuth authentication failed',
  web_env_model_required: 'Please enter model name',
  web_env_authorized: 'Authorized',
  web_env_model_optional: '(optional)',
  web_env_select_to_edit: 'Select environment to edit',
  web_ui_language: 'UI Language',
  web_settings_save: 'Save',
  web_settings_cancel: 'Cancel',
  web_settings_close: 'Close',
