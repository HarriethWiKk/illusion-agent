...
const ZH: Record<string, string> = {
  ...
  ui_cmd_resume: '请使用左侧栏点击会话来恢复，输入框不再支持 /resume',
  ui_cmd_new: '请使用左侧栏"+ 新建会话"按钮',
  ui_cmd_delete: '请使用左侧栏菜单中的删除功能',
  ui_cmd_model: '请使用底部工具栏的模型下拉切换',
  ui_cmd_effort: '请使用底部工具栏的推理强度下拉切换',
  ui_cmd_permissions: '请使用底部工具栏的权限模式下拉切换',
  settings: '设置',
  help: '帮助',
  back: '返回',
...
const EN: Record<string, string> = {
  ...
  ui_cmd_resume: 'Please use the left sidebar to click a session to restore. /resume is no longer supported in the input box.',
  ui_cmd_new: 'Please use the "+ New Session" button in the left sidebar.',
  ui_cmd_delete: 'Please use the delete function in the left sidebar menu.',
  ui_cmd_model: 'Please use the Model dropdown in the bottom toolbar to switch.',
  ui_cmd_effort: 'Please use the Effort dropdown in the bottom toolbar to switch.',
  ui_cmd_permissions: 'Please use the Permission Mode dropdown in the bottom toolbar to switch.',
  settings: 'Settings',
  help: 'Help',
  back: 'Back',
