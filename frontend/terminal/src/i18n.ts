...
const ZH: Dict = {
	...
	agentWizardInherit: '继承当前会话模型',
	agentWizardToolsTitle: '选择工具（Enter 切换 / 选择 Done 完成）',
...
const EN: Dict = {
	...
	agentWizardInherit: 'Inherit current session model',
	agentWizardToolsTitle: 'Select tools (Enter to toggle / pick Done to finish)',
